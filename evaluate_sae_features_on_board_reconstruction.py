...
def cache_examples_and_activations(pieces, sae_activations, board_fens):
    ...
    for j in range(len(pieces)):
        ...
        for square in range(64):
            ...
            for key in sae_activations:
                temp_dic[key] = torch.cat((sae_activations[key][0][convert_indices(positive_indices)], sae_activations[key][0][convert_indices(negative_indices)]))
