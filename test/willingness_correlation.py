...
if __name__ == "__main__":
    ...
    results = analyze_willingness_correlations(
        ...
        layer6_features_path='maia2-sae/dataset/intervention/layer6_offensive_willingness.pickle',
        layer7_features_path='maia2-sae/dataset/intervention/layer7_offensive_willingness.pickle',
    ...
    output_path = 'maia2-sae/offensive_willingness_square_correlations_by_layer.pkl'
