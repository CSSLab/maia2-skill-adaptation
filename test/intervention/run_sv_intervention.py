...
class ProbeIntervention:
    ...
    def run_experiment(self):
        ...
        with open("sv_tp_2.json", "w") as outfile:
        ...
        save_path = './rebuttal_final_sv_intervention_results.pkl'
...
if __name__ == "__main__":
    ...
    intervention = ProbeIntervention(
        cfg,
        offensive_probe_path='rebuttal_oa_reverse_pooled_steering_vectors.pth',
        defensive_probe_path='rebuttal_da_reverse_pooled_steering_vectors.pth'
    )
