                ...
                for boards, _, _, _, _, _, _, _ in dataloader:
                    ...
                    for orig_idx in original_indices['defensive']:
                        ...
                        if layer6_def_feat is not None:
                            # layer6_def_feat = np.random.randint(0, 16384)
                        ...
                        if layer7_def_feat is not None:
                            # layer7_def_feat = np.random.randint(0, 16384)
            ...
            for orig_idx in original_indices['defensive']:
                if layer6_def_feat is not None:
                    ...
                    if not np.isnan(correlation):
                        correlations['layer6'].append(np.abs(correlation))
                
                if layer7_def_feat is not None:
                    correlation, _ = stats.pearsonr(position_data[orig_idx]['probs'], 
                                                position_data[orig_idx]['acts_7'])
                    if not np.isnan(correlation):
                        correlations['layer7'].append(np.abs(correlation))
                ...
                for boards, _, _, _, _, _, _, _ in dataloader:
                    ...
                    for orig_idx in original_indices['offensive']:
                        ...
                        if layer6_off_feat is not None:
                            layer6_off_feat = np.random.randint(0, 16384)
                        ...
                        if layer7_off_feat is not None:
                            layer7_off_feat = np.random.randint(0, 16384)
...
if __name__ == "__main__":
    ...
    results = analyze_awareness_correlations(
        positions_path='maia2-sae/dataset/transmono_positions_for_correlation.pkl',
        layer6_features_path='maia2-sae/dataset/intervention/layer6_offensive_awareness.pickle',
        layer7_features_path='maia2-sae/dataset/intervention/layer7_offensive_awareness.pickle',
    ...
    output_path = 'maia2-sae/offensive_awareness_square_correlations_by_layer_random.pkl'
